...
public abstract class EntityManagerTestSuite {
	...
	public static final String DATA_DIR = System.getProperty("empire.test.data") != null ? System.getProperty("empire.test.data") : new File(TestUtil.getProjectHome(), "test/data").getAbsolutePath();
